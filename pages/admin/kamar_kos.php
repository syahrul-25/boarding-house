            ...
            <div class="card-header  ">               
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">Form Tambah Data Kamar Kos</h4>
              ...
              <form action="" method="post">
               ...
               <div class="form-group">             
                    ...
                    <select name="kode_kategori" id="kode_kategori" class="form-control" required="required" onchange="changeValue(this.value)">     
                    <option value="">Pilih Kategori Kos </option>                      
                      <?php 
                      $kategori_kos=tampil_data("SELECT * FROM kategori_kos
                                                 "); 
                      foreach ($kategori_kos as $row) : ?>
                       <option id="kode_kategori" class="<?php echo $row['kode_kategori']; ?>" 
                              value="<?php echo $row['kode_kategori']; ?>">
                    ...
                    foreach ($kategori_kos as $data) {              
                      ...
                      $jsArray .= "prdName['" . $data['kode_kategori'] . "'] = {kategori_kos:'" . addslashes($data['kategori_kos']) .  "'};\n";

                    }
                    ?>                  
                    </select>    
                    </div> 
                    <input type="hidden" id="kategori_kos" name="kategori_kos">
                  <div class="form-group">             
                    <label for="sumber">Harga Kos</label>
                    <input type="text"  name="harga" class="form-control" placeholder="Masukkan Harga" required="required" autocomplete="off">
                  </div>
              ...
              <div class="card-body">
                <table id="dataTable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="fas fa-edit btn btn-success " href="edit_kamar_kos.php?kode_kamar=<?php echo $data['kode_kamar']; ?>" data-toggle="tooltip" data-placement="top" ></a>
                      <a onclick="return confirm('Yakin ingin menghapus data ini')" href="hapus_kamar_kos.php?kode_kamar=<?php echo $data['kode_kamar']; ?>" class="fas fa-trash-alt btn btn-danger"></a>
                      </td>
                  </tr>
                  <?php $i++ ?>
                  <?php endforeach; ?>
