                  ...
                  <tr style="text-align: center;">
                    ...
                    <td>                     
                      ...
                      <h4 class="modal-title"><?php echo $data['nama']; ?></h4>
                        ...
                        <img src="img/no_image.jpg"  style="width: 300px;"  class="img-fluid mb-2"alt="">
                        </div>
                        <?php else :?> 
                        <div style="text-align: center;" >
                        <?php  
                         echo '<img  style="width: 300px;" src="data:image/jpeg;base64,'.base64_encode( $data['foto_diri'] ).' "/>';  ?>
                        </div>
                        <?php endif; ?> 
                        </div>
                        </div>
                    ...
                    <td>                     
                      ...
                      <h4 class="modal-title"><?php echo $data['nama']; ?></h4>
                        ...
                        <div style="text-align: center;">
                        <?php  
                         echo '<img  style="width: 300px;" src="data:image/jpeg;base64,'.base64_encode( $data['ktp'] ).'"/>'; ?>
